...
@Component({
  selector: 'app-no-gst-billing-table',
  templateUrl: './no-gst-billing-table.component.html',
  styleUrls: ['./no-gst-billing-table.component.scss'],
})
export class NoGstBillingTableComponent implements OnInit {
      ...
      content: [
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              [
                { text: 'Grand Total', colSpan: 4, bold: true, fontSize: 10 },
                { text: '' },
                { text: '' },
                { text: '' },
                {
        ...
        },
        {
          columns: [
            ...
            [
              {
                text: this.toWords.convert(Number(this.getTotal())),
                fontSize: 10,
                margin: [-115, 6, 0, 30],
                wordWrap: 'break-word',
                bold: true,
